Full-stack веб-сервис для поиска исполнителей по уходу за домашними животными. Проект был разработан в качестве дипломной работы и демонстрирует полный цикл создания сложного веб-приложения.
